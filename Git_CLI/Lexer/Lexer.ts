...
export class Lexer{
    ...
    private static readonly SymbolMap = new Map<string, Tokens>([
        // NOTE: Order matters! Longer symbols must come before their shorter prefixes
        // so the greedy scanner extends correctly.
        ["|&", Tokens.PIPE_AND],
        ["||", Tokens.OR],
        ["|", Tokens.PIPE],
        ["&&", Tokens.AND],
